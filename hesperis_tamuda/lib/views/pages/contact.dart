                ...
                collapsed: Column(
                  children: [
                    ...
                    const ListTile(
                      ...
                      title: Text(
                        "Faculté de Lettre et des Sciences Humaines BP 1040 Rabat Maroc",
                      ),
                      onTap: null,
                    ),
                  ],
                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              enableSuggestions: true,
                              decoration:
                                  const InputDecoration(hintText: "Votre Nom"),
                              autocorrect: true,
                              keyboardType: TextInputType.name,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return "Username can not be empty";
                                } else if (!RegExp(r"^[a-z A-Z]+[À-Ý à-ÿ]+$")
                                    .hasMatch(value)) {
